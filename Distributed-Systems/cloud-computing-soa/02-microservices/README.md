# Workshop: Implement a simple microservice architecture 
---

# Simple microservice architecture  Workshop

Welcome! This repository contains all the materials needed to design and implement microservice architecture. Whether you are here to learn or to lead, this guide will get you started.
...
* Architectural Decomposition: You learn to apply separation of concerns
* Stateless Security: You learn to implement token-based state (using JWTs),
