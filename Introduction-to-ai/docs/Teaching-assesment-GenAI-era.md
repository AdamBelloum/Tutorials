...
- Programmes and exam committees need to decide:
  - Which learning objectives must be achieved **without GenAI** (e.g. core disciplinary foundations).
  - Where GenAI use is **allowed or expected**, and how it should be documented and assessed.
...
- Make explicit decisions about:
  - Where GenAI can be used as a **tool** in learning and assessment.
...
- Adapt:
  ...
  - Assessment formats (e.g. oral exams, supervised tasks, process‑oriented).
...
- Policy framework and guidelines on **GenAI in education** define:
  ...
  - Roles and responsibilities (Executive Board, deans, programme directors, exam committees, lecturers, students, TLCs).
...
![bg right:50% 100%](./images/UVA-GenAI-policy.png)
...
![bg right:30% 100%](https://tlc.uva.nl/wp-content/uploads/2026/07/UVA-shootdag-Amsterdam-02022026-ph-by-@ilsoovandijk-03146-scaled.jpg)
